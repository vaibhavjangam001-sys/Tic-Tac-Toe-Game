...
boxes.forEach((box) =>{
    box.addEventListener("click",() =>{
        if(Turn_X){
            ...
            document.querySelector("#Chance-indicator-X").style.backgroundColor = "black"
            document.querySelector("#Chance-indicator-O").style.backgroundColor = "rgb(66, 222, 66)"
            Turn_X = false;
        }
        else {
            box.innerText = "O";
            document.querySelector("#Chance-indicator-X").style.backgroundColor = "rgb(66, 222, 66)";
